CONFIG_PROFILES = {
    ...
    "7x7_center_on": {
        ...
        "playout_fast_cap": 70,
        "infer_batch_size": 32,
        "infer_timeout": 0.0003,
        "eval_infer_batch_size": 32,
        "eval_infer_timeout": 0.0003,
        "mcts_eval_batch_size": 4,
        "mcts_profile": False,
        "mcts_profile_every": 0,
        "temperature_schedule": {5: 1.0, 10: 0.5, 11:0.1},
        "use_forced_playouts": True,
        "use_policy_target_pruning": True,
        "forced_playout_k": 2.0,
        "num_iterations": 600,
    ...
    "9x9_center_on": {
        ...
        "komi": 3,
        "network_head": "conv",
        "freeze_backbone_blocks": 0,
        "freeze_backbone_input": False,
        ...
        "mcts_profile": False,
        "mcts_profile_every": 0,
        "temperature_schedule": {8: 0.7, 15: 0.35, 16: 0.1},
        "use_forced_playouts": True,
        "use_policy_target_pruning": True,
        "forced_playout_k": 2.0,
        "num_iterations": 300,
        ...
        "ownership_loss_weight_capture": 0.25,
